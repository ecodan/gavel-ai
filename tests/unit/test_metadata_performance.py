...
class TestMetadataPerformance:
    ...
    def test_metadata_collection_overhead(self) -> None:
        ...
        assert collection_duration < 5.0, f"Metadata collection took {collection_duration}s for 1000 scenarios - too slow"
    ...
    def test_json_serialization_performance(self) -> None:
        ...
        assert serialization_time < 0.05, f"JSON serialization took {serialization_time}s - too slow"
