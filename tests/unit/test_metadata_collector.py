...
class TestRunMetadataCollector:
    ...
    def test_record_scenario_complete(self) -> None:
        ...
        assert collector.scenario_timings[scenario_id]["end"] > collector.scenario_timings[scenario_id]["start"]
    ...
    def test_scenario_timing_calculations(self) -> None:
        ...
        for i in range(3):
            ...
            duration_ms = (collector.scenario_timings[scenario_id]["end"] - 
                         collector.scenario_timings[scenario_id]["start"]) * 1000
